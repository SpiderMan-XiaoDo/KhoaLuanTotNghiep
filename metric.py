...
def compute_metrics( metric, start_logits, end_logits, features, examples):
    import collections
    import json
    import numpy as np
    ...
    args_metric = 'squad'
    args_device = 'cuda'
    args_output_dir = '/kaggle/working'
    args_scheduler = 'linear'
    args_pretrained_model = 'vinai/bartpho-syllable-base'
    args_batch_size = 2
#     args_epochs = 10
    args_lr = 2e-5
